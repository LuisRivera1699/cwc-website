...
export default function TeamCard({ team }: TeamCardProps) {
    ...
    return (
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-700 hover:border-blue-500">
            <div className="flex flex-col items-center text-center space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm sm:text-base text-blue-300 font-mono">
                        ${team.ticker}
                    </p>
